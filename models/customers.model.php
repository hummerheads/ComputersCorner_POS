...
class ModelCustomers{
	...
	static public function mdlAddCustomer($table, $data){
		...
		$stmt = Connection::connect()->prepare("INSERT INTO $table(name, idDocument, email, phone, address) VALUES (:name, :idDocument, :email, :phone, :address)");
	...
	static public function mdlEditCustomer($table, $data){
		...
		$stmt = Connection::connect()->prepare("UPDATE $table SET name = :name, idDocument = :idDocument, email = :email, phone = :phone, address = :address WHERE id = :id");
